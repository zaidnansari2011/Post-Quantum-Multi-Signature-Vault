...
__defs['curves/abstract/fft.js'] = function (__exports, __req) {
/**
 * Experimental implementation of NTT / FFT (Fast Fourier Transform) over finite fields.
 * API may change at any time. The code has not been audited. Feature requests are welcome.
 * @module
 */
const { aarray, validateObject } = __req('curves/utils.js');
const { validateField } = __req('curves/abstract/modular.js');
...
Object.assign(__exports, { isPowerOfTwo, nextPowerOfTwo, reverseBits, log2, bitReversalInplace, bitReversalPermutation, rootsOfUnity, FFTCore, FFT, poly });
};
__defs['curves/abstract/modular.js'] = function (__exports, __req) {
/**
...
const { aarray, abool, abytes, afunction, anumber, aobject, asafenumber, bitLen, bytesToNumberBE, bytesToNumberLE, numberToBytesBE, numberToBytesLE } = __req('curves/utils.js');
...
Object.assign(__exports, { mod, pow, pow2, invert, invertCt, tonelliShanks, FpSqrt, isNegativeLE, validateField, FpPow, FpInvertBatch, FpDiv, FpLegendre, FpIsSquare, nLength, Field, FpSqrtOdd, FpSqrtEven, getFieldBytesLength, getMinHashLength, mapHashToField });
};
__defs['curves/utils.js'] = function (__exports, __req) {
/**
 * Hex, bytes and number utilities.
 * @module
 */
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const { abytes: abytes_, anumber: anumber_, bytesToHex: bytesToHex_, concatBytes: concatBytes_, hexToBytes: hexToBytes_, isBytes: isBytes_, randomBytes: randomBytes_ } = __req('hashes/utils.js');
/**
 ...
 * ```
 */
const abytes = (value, length, title) => abytes_(value, length, title);
/**
...
Object.assign(__exports, { aarray, abytes, anumber, astring, aobject, afunction, bytesToHex, concatBytes, hexToBytes, isBytes, randomBytes, abool, abignumber, asafenumber, numberToHexUnpadded, hexToNumber, bytesToNumberBE, bytesToNumberLE, numberToBytesBE, numberToBytesLE, numberToVarBytesBE, equalBytes, copyBytes, asciiToBytes, isPosBig, inRange, aInRange, bitLen, bitGet, bitSet, bitMask, createHmacDrbg, validateObject, notImplemented });
};
__defs['hashes/_md.js'] = function (__exports, __req) {
/**
 * Internal Merkle-Damgard hash utils.
 * @module
 */
const { setU64FromNum } = __req('hashes/_u64.js');
const { abytes, aexists, aoutput, createView } = __req('hashes/utils.js');
/**
...
Object.assign(__exports, { Chi, Maj, HashMD, SHA256_IV, SHA224_IV, SHA384_IV, SHA512_IV });
};
__defs['hashes/_u64.js'] = function (__exports, __req) {
...
Object.assign(__exports, { add, add3H, add3L, add4H, add4L, add5H, add5L, fromBig, fromNumH, fromNumL, rotr32H, rotr32L, rotrBH, rotrBL, rotrSH, rotrSL, setU64FromNum, shrSH, shrSL, split, toBig });
};
__defs['hashes/sha2.js'] = function (__exports, __req) {
/**
 ...
 * @module
 */
const { Chi, HashMD, Maj, SHA224_IV, SHA256_IV, SHA384_IV, SHA512_IV } = __req('hashes/_md.js');
const u64 = __req('hashes/_u64.js');
const { clean, createHasher, oidNist, rotr } = __req('hashes/utils.js');
/**
...
Object.assign(__exports, { _SHA256, _SHA224, _SHA512, _SHA384, _SHA512_224, _SHA512_256, sha256, sha224, sha512, sha384, sha512_256, sha512_224 });
};
__defs['hashes/sha3.js'] = function (__exports, __req) {
/**
 ...
 * @module
 */
const { split } = __req('hashes/_u64.js');
// prettier-ignore
const { abool, abytes, aexists, anumber, aoutput, checkOpts, clean, createHasher, oidNist, swap32IfBE, u32 } = __req('hashes/utils.js');
...
Object.assign(__exports, { keccakP, Keccak, sha3_224, sha3_256, sha3_384, sha3_512, keccak_224, keccak_256, keccak_384, keccak_512, shake128, shake256, shake128_32, shake256_64 });
};
__defs['hashes/utils.js'] = function (__exports, __req) {
/**
...
Object.assign(__exports, { isBytes, anumber, abool, abytes, copyBytes, ahash, aexists, aoutput, u8, u32, clean, createView, rotr, rotl, isLE, byteSwap, swap8IfBE, byteSwap32, swap32IfBE, bytesToHex, hexToBytes, nextTick, asyncLoop, utf8ToBytes, kdfInputToBytes, concatBytes, validateObject, checkOpts, createHasher, randomBytes, oidNist });
};
__defs['pq/_crystals.js'] = function (__exports, __req) {
/**
 * Internal methods for lattice-based ML-KEM and ML-DSA.
 * @module
 */
/*! noble-post-quantum - MIT License (c) 2024 Paul Miller (paulmillr.com) */
const { FFTCore, reverseBits } = __req('curves/abstract/fft.js');
const { shake128, shake256 } = __req('hashes/sha3.js');
const { cleanBytes, getMask } = __req('pq/utils.js');
/**
...
Object.assign(__exports, { genCrystals, XOF128, XOF256 });
};
__defs['pq/ml-dsa.js'] = function (__exports, __req) {
/**
 ...
 */
/*! noble-post-quantum - MIT License (c) 2024 Paul Miller (paulmillr.com) */
const { abool } = __req('curves/utils.js');
const { shake256 } = __req('hashes/sha3.js');
const { genCrystals, XOF128, XOF256 } = __req('pq/_crystals.js');
const { abytes, checkHash, cleanBytes, equalBytes, getMessage, getMessagePrehash, randomBytes, splitCoder, validateOpts, validateSigOpts, validateVerOpts, vecCoder } = __req('pq/utils.js');
...
Object.assign(__exports, { PARAMS, ml_dsa44, ml_dsa65, ml_dsa87 });
};
__defs['pq/utils.js'] = function (__exports, __req) {
/**
 * Utilities for hex, bytearray and number handling.
 * @module
 */
/*! noble-post-quantum - MIT License (c) 2024 Paul Miller (paulmillr.com) */
const { abytes, abytes: abytes_, ahash: ahash_, anumber, concatBytes, isBytes, isLE, randomBytes: randb } = __req('hashes/utils.js');
/**
